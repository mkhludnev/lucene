 ...
 * org.apache.lucene.search.aijoin.AIJoinIndex} is the entry point: it owns the auxiliary index and
 * builds its pair columns lazily on first search, so queries created with {@link
 * org.apache.lucene.search.aijoin.AIJoinIndex#newJoinQuery} run against a bare to-side searcher
